            ...
            <div className="flex-1 overflow-y-scroll mt-3 text-sm space-y-3">
                {
                    chats.filter((chat) =>
                        ...
                        <div
                            ...
                            <img onClick={e => toast.promise(deleteChat(e, chat._id), { loading: 'Deleting...' })} src={assets.bin_icon} className="block md:hidden group-hover:block w-4 cursor-pointer not-dark:invert" alt="" />
                        </div>
                    ))
                }
            </div>
